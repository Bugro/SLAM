...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_setup_tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/leo/workspace/SLAM_projet_supelec/catkin_ws/install/${idir}'.  Ask the maintainer 'leo <leo@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/leo/workspace/SLAM_projet_supelec/catkin_ws/install/lib;/opt/ros/jade/lib)
